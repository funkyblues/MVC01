...
public class MemberListController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) 
		...
		// 3. 회원전체 리스트 HTML로 만들어서 응답하기
		// 응답되는 데이터 안에 한글이 있는 경우 - UTF-8로 인코딩 필요
		
		// 서버가 어떤 유형의 데이터를 보내는지를 알려주어야 함 -> MIME Type
		// 데이터를 보내기 전에! 설정을 해주어야 한다.
		// System.out.println(list);
		response.setContentType("text/html;charset=utf-8"); // 이렇게 적는것을 MIME Type이라고 한다.
